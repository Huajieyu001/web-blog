...
public class VerifyInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        try {
            ...
            Account readAccount = mapper.readValue(accountString, Account.class);
            ...
            // 判断当前用户是否是已注册用户
            Boolean member = stringRedisTemplate.opsForSet().isMember(RedisConstant.REDIS_KEY_ACCOUNT_USED_USERNAME, readAccount.getUsername());
